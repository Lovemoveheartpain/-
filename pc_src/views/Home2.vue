    ...
    <el-row :gutter="10">
      ...
      <el-col :xs="24" :sm="18">
        ...
        >
          ...
          <p v-if="loading" class="bottom">
            加載更多
            <i class="el-icon-loading"></i>...
          </p>
          <p v-if="noMore" class="bottom">没有更多了</p>
        </div>
      </el-col>
    </el-row>
  </div>
  ...
  methods: {
    load() {
      ...
      setTimeout(() => {
        ...
        Axios.get(`http://localhost:8081/data${this.count}.json`)
          .then(res => {
    ...
    click(index) {
      ...
      document.getElementsByClassName("price_div")[this.num].style.color =
        "red";
    },
    change() {
